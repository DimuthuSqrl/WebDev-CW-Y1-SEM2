...
var divEl = document.getElementById("written-query"); // function to view query
...
function viewQuery() {
  ...
  if (!isInvalid()) {
    ...
    element.classList.add("none"); //displaying the query in a div

    divEl = document.getElementById("written-query");
    divEl.classList.remove("none"); //concatenating the input from the fields
